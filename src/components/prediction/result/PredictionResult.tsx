            ...
            <CardContent className="p-0">
              <div className="bg-gradient-to-r from-indigo-600 to-violet-600 p-4 text-white">
                <div className="flex justify-between items-center">
                  ...
                  <Badge variant="outline" className="bg-green-600 hover:bg-green-700 text-white border-green-500">Live Now</Badge>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-0">
                <div className="p-4 bg-indigo-50 dark:bg-indigo-900/30">
                  <div className="flex justify-between mb-2">
                    <span className="font-semibold flex items-center gap-1 text-indigo-800 dark:text-indigo-200">
                  ...
                  <div className="space-y-2">
                    {["AAPL", "NVDA", "MSFT"].map((stock, i) => (
                      <div key={i} className="flex justify-between items-center p-2 bg-white dark:bg-slate-800 rounded">
                        <span>{stock}</span>
                ...
                <div className="p-4 bg-white dark:bg-slate-900">
                  <div className="flex justify-between mb-2">
                    <span className="font-semibold flex items-center gap-1 text-purple-800 dark:text-purple-200">
                  ...
                  <div className="space-y-2">
                    {["AMZN", "GOOGL", "TSLA"].map((stock, i) => (
                      <div key={i} className="flex justify-between items-center p-2 bg-indigo-50 dark:bg-indigo-900/30 rounded">
                        <span>{stock}</span>
              ...
              <div className="p-4 border-t border-gray-200 dark:border-gray-700">
                <div className="flex justify-between items-center">
                  ...
                  <Badge variant="outline" className="bg-blue-500/20 border-blue-500/40 text-blue-700 dark:text-blue-300">
          ...
          <Card>
            <CardContent className="p-4">
              <div className="space-y-4">
                <div>
                  <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400">Tournament Name</h3>
                  <p className="font-medium">Weekly Stock Championship</p>
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400">Timeframe</h3>
                    <p className="font-medium">7 Days</p>
                  </div>
                  <div>
                    <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400">Bracket Size</h3>
                    <p className="font-medium">3 Stocks</p>
                  </div>
                  <div>
                    <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400">AI Opponent</h3>
                    <p className="font-medium">ValueHunter</p>
                  </div>
                  <div>
                    <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400">Potential Points</h3>
                    <p className="font-medium">Up to 500 pts</p>
                  </div>
                </div>
                <div>
                  <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400">Tournament Rules</h3>
                  <ul className="text-sm list-disc list-inside mt-1 text-gray-600 dark:text-gray-300">
