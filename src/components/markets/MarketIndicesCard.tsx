...
const MarketIndicesCard: React.FC<MarketIndicesCardProps> = ({
  ...
  return <Card className="shadow-sm border-0 overflow-hidden">
      
      <CardContent className="p-0">
        {isError && <div className="p-4 bg-red-50 dark:bg-red-900/20 text-red-700 dark:text-red-400 text-sm flex items-center">
        ...
        <div className="divide-y">
          {isLoading ?
        // Loading skeletons
        Array(4).fill(0).map((_, i) => <div key={i} className="p-4 flex justify-between items-center">
        ...
        // Market indices data
        marketIndices.map((index, i) => <div key={i} className="p-4 flex justify-between items-center">
                <div>
        ...
        {usingMockData && <div className="px-4 py-3 text-xs flex items-center text-amber-700 bg-amber-50 dark:bg-amber-900/20 dark:text-amber-400 border-t">
